...
INTEGRATION (lead-driven, no lane file)
  ...
  hash-based selective re-render, caption policy (broll burn-in + sidecar),
  sound pass, QC gates, both export formats.
...
2. Integration mini-episode renders end-to-end in both formats with broll-only
  caption burn-in (where applicable), SFX, grading, and QC report.
