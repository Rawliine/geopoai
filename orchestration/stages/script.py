...
def build(ctx: StageContext) -> tuple[str, dict]:
    ...
    instruction = (
        ...
        "- Keep the VO jargon-free: never say \"game theory\", \"payoff matrix\", "
        "\"Nash equilibrium\", \"dominant strategy\", or \"zero-sum\" — most viewers "
        "don't know the terms and they break the flow. Show the incentives in plain "
        "language (who wants what, what each side risks, why neither backs down) and "
        "let the map/manim visuals carry the formal structure.\n"
